...
- предоставьте привилегии на все операции данному пользователю на таблицы БД test-db
- создайте пользователя test-simple-user  
- предоставте данному пользователю права на SELECT/INSERT/UPDATE/DELETE данных таблиц БД test-db
